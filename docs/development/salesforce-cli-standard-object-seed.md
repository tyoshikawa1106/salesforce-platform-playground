...
```sh
sf apex run --file scripts/apex/standard-objects/seed-standard-objects.apex --target-org <alias>
```
...
- `scripts/apex/standard-objects/seed-standard-objects.apex`
- `scripts/apex/standard-objects/cleanup-standard-objects.apex`
