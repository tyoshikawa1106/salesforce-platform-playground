...
- Flow、LWC、Aura、Visualforce、Apex Trigger、Batch、Scheduler を追加、削除する場合は、[機能仕様書ルール](specification-rules.md) と対応する主仕様書、詳細仕様を確認する。
...
- Flow、LWC、Aura、Visualforce、Apex Trigger、Batch、Scheduler を追加、削除した場合は、対応する機能仕様書と索引を同じ変更で更新し、`npm run docs:check` で構造の対応を確認する。
- ユーザーから機能仕様書の定期的な一括更新を依頼された場合は、[機能仕様書ルール](specification-rules.md) に従い、AI エージェントが実装を基準に対象全体を棚卸しする。
