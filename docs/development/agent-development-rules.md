...
| branch、commit、PR、merge              | [GitHub 運用ルール](github-rules.md)                                 |
...
- branch、commit、PRの共通手順は`docs/development/github-rules.md`、このリポジトリ固有のGitHub運用は`docs/development/github-repository-rules.md`に従う。
