...
retrieve の具体的な事前確認と差分確認は [メタデータ取得ルール](../deployment/retrieve-rules.md) に従います。

## 検証

メタデータを変更したら、[変更チェックリスト](change-checklist.md)、[Apex 開発ルール](apex-rules.md)、[Dev 組織デプロイ](../deployment/dev-org-deploy.md) の方針に従います。
