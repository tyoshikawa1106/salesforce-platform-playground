...
- Contact がある場合、氏名を Contact レコードへのリンクとして表示し、別タブで開きます。
- Account がある場合、会社名を Account レコードへのリンクとして表示し、別タブで開きます。
...
- 会社名の上に罫線を表示して人物情報と会社情報を区切り、会社名と Web サイト URL はそれぞれ 1 行分の全幅領域へ配置します。
...
- Contact と Case の Account がある場合の全項目、別タブで開くリンク、人物アイコン
