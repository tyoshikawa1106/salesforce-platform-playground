...
```sh
sf apex run --file seed-standard-objects.apex --target-org <alias>
```
...
- `data/test-data/standard-objects/seed-standard-objects.apex`
- `data/test-data/standard-objects/cleanup-standard-objects.apex`
