...
```sh
sf apex run --file scripts/apex/test-data/standard-objects/seed-standard-objects.apex --target-org <alias>
```
...
- `scripts/apex/test-data/standard-objects/seed-standard-objects.apex`
- `scripts/apex/test-data/standard-objects/cleanup-standard-objects.apex`
- `data/test-data/standard-objects/import-plan.json`
