...
| タイトル                          | 概要                                                   |
| --------------------------------- | ------------------------------------------------------ |
| [setup/](#セットアップ)           | ローカルツール、組織ログイン、環境セットアップ         |
| [development/](#開発運用)         | Apex やメタデータ変更時の実務チェック                  |
| [deployment/](#デプロイ)          | デプロイ、取得、削除変更、新規組織への再現に関するメモ |
| [discussions/](#ディスカッション) | 設計案、課題、見直し内容など、判断過程を整理したメモ   |
| [knowledge/](#ナレッジ)           | Salesforce Platform の概念を学ぶためのメモ             |
