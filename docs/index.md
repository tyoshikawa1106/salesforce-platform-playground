...
| タイトル                                                                                    | 概要                                            |
| ------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| [Salesforce 組織操作ルール](deployment/salesforce-org-deploy-rules.md)                      | validate / deploy / retrieve / test の実行判断  |
...
| [.gitignore 管理方針の判断記録](discussions/gitignore-management-policy.md)                                      | Git 管理対象外にするファイルの判断記録             |
