...
- Flow、LWC、Aura、Visualforce、Apex Trigger、Batch、Scheduler を追加、削除する場合は、`docs/development/specification-rules.md` に従い、対応する機能仕様書と索引を同じ変更で更新する。既存機能の仕様書は、ユーザーが定期的な一括更新を依頼したときに、AI エージェントが実装を基準に更新する。
