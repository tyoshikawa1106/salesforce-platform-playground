...
- エージェントが Issue / PR を作成・更新する場合は、ラベル、assignee、Project 紐づけを設定・確認し、運用は `docs/development/rules.md` に従う。
...
- PR マージ後の `main` 同期とマージ済み作業ブランチ削除は、`docs/development/rules.md` の条件を満たす場合は自動実行してよい。
